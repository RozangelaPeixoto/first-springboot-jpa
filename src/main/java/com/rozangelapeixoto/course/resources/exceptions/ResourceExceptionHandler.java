package com.rozangelapeixoto.course.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> resourceNotFound(DatabaseExpection e, HttpServletRequest request){
